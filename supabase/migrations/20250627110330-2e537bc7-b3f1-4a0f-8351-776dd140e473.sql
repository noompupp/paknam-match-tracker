...
-- Fix the database function conflict and enhance the rating generation
...
BEGIN
  ...
  LOOP
    ...
    -- Enhanced FPL points calculation
    base_fpl_points := CASE 
      WHEN player_record.total_minutes >= 60 THEN 2 
    ...
    -- Enhanced participation rating based on minutes and contribution
    ...
    -- Insert/update the rating record

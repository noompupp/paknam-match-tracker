...
-- Fix team name resolution and match result calculation in the rating generation function
...
BEGIN
  ...
  -- Determine match results based on actual scores (FIXED)
  ...
  FOR player_record IN
    SELECT DISTINCT 
      ...
      -- FIXED: Properly resolve team names using LEFT JOIN
      COALESCE(
        CASE 

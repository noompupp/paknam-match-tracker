  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile-specific positioning and width constraints
        "sm:max-w-[calc(100vw-2rem)] max-w-[calc(100vw-1rem)]",
        "sm:left-0 sm:right-auto", // Desktop: normal positioning
        "max-sm:left-1/2 max-sm:-translate-x-1/2", // Mobile: center alignment
        position === "popper" &&

  ...
  <EnhancedDialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: 90% height with proper centering, full width - Updated padding
        "h-[90vh] w-[95vw] sm:h-auto sm:w-auto",
        // Enhanced padding: top 5%, bottom 15% on mobile, keep normal on desktop
        "pt-[5vh] pb-[15vh] sm:pt-0 sm:pb-0",
        className
      )}
      {...props}
    >
